...
class JuicyWidthAudioProcessor : public juce::AudioProcessor
{
public:
    JuicyWidthAudioProcessor();
    ~JuicyWidthAudioProcessor() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(JuicyWidthAudioProcessor)
};
